...
RUN_DIR = os.environ.get("RUN_DIR", "runs/natural_heads64")
...
def main():
    ...
    top64 = [(int(i // nH), int(i % nH)) for i in order[:64]]
    ...
    CONDS = (("none", None), ("top64_rest", to_ld(top64)),)
    out = {"conditions": {}}
