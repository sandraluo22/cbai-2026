...
Runs from runs/gemma_qwen/acts_model_{a,b}.npz (200k occ, per-step tags).
"""
...
def main():
    g_rows, g_H = per_model("runs/gemma_qwen/acts_model_a.npz", GEMMA_LAYER)
    q_rows, q_H = per_model("runs/gemma_qwen/acts_model_b.npz", QWEN_LAYER)
    ...
    json.dump({"gemma_layer": GEMMA_LAYER, "qwen_layer": QWEN_LAYER, "Nw": NW,
              ...
              open("runs/gemma_qwen/paper_faithful.json", "w"), indent=2)
    ...
    fig.tight_layout(); fig.savefig("runs/gemma_qwen/paper_faithful_emergence.png", dpi=140)
    ...
    fig2.tight_layout(); fig2.savefig("runs/gemma_qwen/paper_faithful_pca.png", dpi=140)
