...
def clean_match_mismatch():
    za = np.load("runs/v1/square_grid/gemma_qwen/acts_model_a.npz", allow_pickle=False)
    zb = np.load("runs/v1/square_grid/gemma_qwen/acts_model_b.npz", allow_pickle=False)
...
def main():
    ...
    fig.tight_layout(); fig.savefig("runs/v1/square_grid/gemma_qwen/controls_redo.png", dpi=140)
    print("\nwrote runs/v1/square_grid/gemma_qwen/controls_redo.png")
