...
llama_rsa = json.load(open("runs/llama/llama_grid_rsa.json"))
pf = json.load(open("runs/gemma_qwen/paper_faithful.json"))
le = json.load(open("runs/llama/llama_emergence.json"))
...
fig.tight_layout()
fig.savefig("runs/llama/three_model_comparison.png", dpi=140)
...
print("wrote runs/llama/three_model_comparison.png")
